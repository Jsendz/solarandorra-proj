...
const Tres = () => {
  return (
    <div className="h-full lg:h-screen w-full max-w-screen-2xl mx-auto">
        <h2 className="text-center font-bold text-4xl lg:text-6xl py-20">Inside Nature Experience</h2>

    <div className="lg:w-full flex flex-col items-center pb-20 justify-center lg:flex-row lg:justify-around lg:items-center lg:pt-20  text-center">
    <div className="bg-gray-200 hover:bg-white hover:cursor-pointer hover:shadow-xl rounded-lg w-60 xl:w-80 h-full mb-6 lg:mb-0 ">
